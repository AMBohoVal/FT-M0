...
function esEntero(numero) {
  ...
  // Tu código:
  if (isNaN(numero) === false && Number.isInteger(numero) === true) return true;
    else return false;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (a === -1 || b === -1 || c === -1) return "Hay negativos";
   else if (a === 0 || b === 0 || c === 0) return "Error"
    else if (num1 > num2 && num1 > num3 && a===1) return "Número 1 es mayor y positivo";
...
function tieneTresDigitos(numero){
  ...
  //Escribe tu código aquí
  if (numero.toString().length === 3) return true; //Se transforma el numero en string, ya que el length solo valida string.
    else return false;
